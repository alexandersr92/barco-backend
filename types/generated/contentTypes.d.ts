...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Configuraci\u00F3n global del sitio: navegaci\u00F3n, footer y datos de contacto';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ebankingUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://ebanking.avanzbanc.com'>;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'P\u00E1ginas del sitio construidas con secciones';
    displayName: 'P\u00E1gina';
    pluralName: 'pages';
    singularName: 'page';
  };
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Productos financieros: cuentas, tarjetas y cr\u00E9ditos';
